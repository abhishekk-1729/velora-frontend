...
API_KEY = "key_apUQQV1fyjfdfd5Y6X9uRA"
...
# Example usage
input_file = "189_onwards.xlsx"  # Replace with your input file name
output_file = "websites_with_screenshots4.xlsx"  # Output file name
