...
API_KEY = "key_hzf5A3cv7MYidVkexpPG5K"
...
# Example usage
input_file = "334_onwards.xlsx"  # Replace with your input file name
output_file = "websites_with_screenshots.xlsx"  # Output file name
