...
API_KEY = "key_cNjXLviPtshsvaYMCkH5ED"
...
# Example usage
input_file = "89_onwards.xlsx"  # Replace with your input file name
output_file = "websites_with_screenshots3.xlsx"  # Output file name
